  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        ...
        {/* Login Form */}
        <form className="mt-8 space-y-6 bg-white p-8 shadow-sm border border-gray-100" onSubmit={handleLogin}>
          {message && (
            <div className="p-4 text-sm bg-red-50 text-red-700 border border-red-200">
              {message}
            </div>
          )}
